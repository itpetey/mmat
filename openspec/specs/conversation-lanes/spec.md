...
## Purpose
Conversation lanes isolate UI attention (not project memory) by tagging messages and events with lane metadata. Lanes support single-lane, multi-lane, and global project views, LLM tool-based lane creation, notification deep-linking, and inline action-request semantics.
